...
<head>
    ...
    <style>
        body {
            background-color: rgba(229, 107, 20, 0.962);
            font-size: 20px;
        }
        ...
        .box {
            width: 500px;
            height: 300px;
            background-color: rgba(1, 1, 26, 0.977);
            margin: 150px auto;
            border: 7px dashed rgb(33, 191, 222);
        }
...
![alt text](<Screenshot 2025-12-10 175519.png>)

## HOMEPAGE:
![alt text](<Screenshot 2025-12-10 175428.png>)
